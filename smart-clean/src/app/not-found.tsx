    ...
    <div className="min-h-screen flex flex-col justify-center items-center p-8 md:p-16 lg:p-24 font-sans relative overflow-hidden bg-neutral-50 text-neutral-900">
      ...
      <div className="relative z-10 w-full max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
        ...
        <div className="flex flex-col items-start text-left order-2 lg:order-1">
          <h1
            className="text-4xl md:text-6xl lg:text-7xl font-extrabold tracking-tight mb-4 md:mb-6 font-serif text-neutral-900 animate-in fade-in slide-in-from-top-4 duration-700"
          >
            Error 404
          </h1>

          <p
            className="text-base md:text-xl lg:text-2xl mb-6 md:mb-10 max-w-lg leading-relaxed text-neutral-600 animate-in fade-in slide-in-from-top-2 duration-700 delay-200 fill-mode-both"
          >
            It looks like this page was washed away. The page does not exist.
          </p>

          <div 
            className="animate-in fade-in slide-in-from-bottom-2 duration-700 delay-300 fill-mode-both"
          >
            <button
              onClick={() => router.back()}
        ...
        <div
          className="relative w-full aspect-square md:aspect-[4/3] lg:aspect-square order-1 lg:order-2 flex items-center justify-center animate-in fade-in zoom-in-95 duration-1000"
        >
          <Image
