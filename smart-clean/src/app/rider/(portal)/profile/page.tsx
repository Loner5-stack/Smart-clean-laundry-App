  ...
  return (
    <div className="min-h-full bg-[#F7F8FA] dark:bg-[#090B11] p-4">
      ...
      <div className="bg-white dark:bg-[#111827] rounded-3xl p-6 border border-gray-100 dark:border-white/5 shadow-sm mb-6 flex items-center gap-4">
        ...
        <div>
          <h2 className="font-bold text-gray-900 dark:text-white text-lg">John Doe</h2>
          <p className="text-xs text-gray-500 dark:text-gray-400">Rider ID: #RD-4921</p>
      ...
      <div className="mb-8">
        ...
        <div className="bg-white dark:bg-[#111827] rounded-2xl border border-gray-100 dark:border-white/5 shadow-sm overflow-hidden">
          <div className="px-4 py-3.5 border-b border-gray-50 dark:border-white/5 flex justify-between items-center">
            <span className="text-sm font-semibold text-gray-600 dark:text-gray-300">Vehicle Type</span>
            <span className="text-sm font-bold text-gray-900 dark:text-white">Delivery Van</span>
          </div>
          <div className="px-4 py-3.5 flex justify-between items-center">
            <span className="text-sm font-semibold text-gray-600 dark:text-gray-300">License Plate</span>
            <span className="text-sm font-bold text-gray-900 dark:text-white uppercase">AAA-123-BB</span>
          </div>
        </div>
      </div>
        ...
        <div className="bg-white dark:bg-[#111827] rounded-2xl border border-gray-100 dark:border-white/5 shadow-sm overflow-hidden divide-y divide-gray-50 dark:divide-white/5">
          ...
          >
            <div className="flex items-center gap-3">
              <div className="text-brand-cobalt bg-brand-cobalt/10 p-2 rounded-lg"><User size={18} /></div>
          ...
          >
            <div className="flex items-center gap-3">
              <div className="text-brand-cobalt bg-brand-cobalt/10 p-2 rounded-lg"><FileText size={18} /></div>
              <span className="text-sm font-bold text-gray-900 dark:text-white">Earnings History</span>
            </div>
            <ChevronRight size={18} className="text-gray-400" />
          </button>
        </div>
      ...
      <button 
        onClick={() => {
          document.cookie = "rider_token=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/;";
