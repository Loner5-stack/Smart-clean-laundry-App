...
export default function AccountabilityPage() {
  ...
  const nextTierThreshold = 31;
  const currentTier = "Tier 2";
  const progressPercent = Math.min((totalOrders / nextTierThreshold) * 100, 100);
  ...
  const tiers = sharedLoyaltyConfig.map(tier => {
  ...
  return (
    <div className="px-4 md:px-6 py-6 lg:py-8 max-w-6xl mx-auto pb-24 lg:pb-10">
      {/* Page Header */}
      <motion.div 
          ...
          >
            ...
            <div className="mb-4">
              <div className="flex justify-between text-xs font-bold text-gray-500 mb-2">
                <span>Tier 2 Started</span>
                <span>{nextTierThreshold - totalOrders} orders to Tier 3</span>
              </div>
